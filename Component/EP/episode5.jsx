...
import { ep05BossListAtom } from "../../src/index"
...
export default function Ep05() {
    ...
    const EpContent = ({ id, areaName, bossName, time }) => {
        ...
        function notify () {
            toast(`에피소드 5의 ${bossName}의 필드 이벤트가 10분 남았어요!`, { limit:1, autoClose:600000, pauseOnFocusLoss:false });
        }
        ...
        <section className="text-gray-600 body-font">
            <div className="px-5 py-24 mx-auto text-center">
                <div className="flex flex-col text-center w-full mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">EP05</h1>
                    <p className="lg:w-1/3 mx-auto leading-relaxed text-base">에피소드 5의 필드보스 타이머입니다.</p>
                </div>
                <Segment>
